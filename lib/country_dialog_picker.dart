...
class CountryPickerDialog extends StatefulWidget {
  ...
  final List<CountryPhone> filteredCountries;
...
class _CountryPickerDialogState extends State<CountryPickerDialog> {
  late List<CountryPhone> _filteredCountries;
  late CountryPhone? _selectedCountry;

  @override
  void initState() {
    _selectedCountry = widget.selectedCountry;
    _filteredCountries =
        widget.filteredCountries.toList()..sort(
          (a, b) => a
