...
class PhoneNumber {
  ...
  factory PhoneNumber.fromCompleteNumber({required String completeNumber}) {
    ...
    try {
      CountryPhone country = getCountry(completeNumber);
      String number;
  ...
  static CountryPhone getCountry(String phoneNumber) {
    if (phoneNumber == "") {
      throw NumberTooShortException();
    }

    RegExp validPhoneNumber = RegExp(r"^[+0-9]*[0-9]*$");
    ...
    if (phoneNumber.startsWith("+")) {
      return countries.firstWhere(
        (CountryPhone country) => phoneNumber
            .substring(1)
